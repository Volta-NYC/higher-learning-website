...
const GRADE_GROUPS = [
  ...
  { grades: "Grades 5–6", label: "Upper Elem.", color: "#02014a" },
  { grades: "Grade 7",    label: "Middle / SHSAT", color: "#02014a" },
];
      ...
      <div style={{
        ...
        <span style={{
          ...
          background: row.highlight
            ...
            : "rgba(2,1,74,0.04)",
          border: `1px solid ${row.highlight ? "rgba(200,146,42,0.25)" : "rgba(2,1,74,0.08)"}`,
          borderRadius: "8px",
          fontSize: "0.78rem",
          fontWeight: 700,
          color: row.highlight ? "#c8922a" : "#02014a",
          fontFamily: "'DM Sans', system-ui, sans-serif",
          whiteSpace: "nowrap" as const,
        }}>
          Time · {row.time}
  ...
  return (
    <>
      <style>{`
        ...
        .hl-class-card:hover {
          box-shadow: 0 8px 28px rgba(2,1,74,0.1) !important;
              ...
              >
                ...
                {[
                  ...
                  <div key={item.label} style={{
                    ...
                    <div>
                      <div style={{ fontSize: "0.62rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(2,1,74,0.35)", marginBottom: "0.15rem", fontFamily: "'DM Sans', system-ui, sans-serif" }}>{item.label}</div>
                  ...
                  {SATURDAY_CLASSES.map((row, i) => (
                    <tr key={i} style={{ background: i % 2 === 0 ? "#fff" : "rgba(2,1,74,0.015)" }}>
                      <td style={{ padding: "0.875rem 1.2rem", fontSize: "0.84rem", color: "#02014a", borderBottom: "1px solid rgba(2,1,74,0.05)", fontFamily: "'DM Sans', system-ui, sans-serif", fontWeight: 600 }}>
                        {row.subject}
                        <span style={{ display: "block", fontSize: "0.72rem", color: "rgba(2,1,74,0.38)", fontWeight: 400, marginTop: "2px" }}>{row.subjectZh}</span>
                      </td>
                      <td style={{ padding: "0.875rem 1.2rem", fontSize: "0.84rem", color: "#02014a", borderBottom: "1px solid rgba(2,1,74,0.05)", fontFamily: "'DM Sans', system-ui, sans-serif", whiteSpace: "nowrap" as const }}>
                        {row.grade}
                        <span style={{ display: "block", fontSize: "0.72rem", color: "rgba(2,1,74,0.38)", marginTop: "2px" }}>{row.gradeZh}</span>
                      </td>
