...
const MONTH_COLORS: Record<string, { bg: string; border: string; text: string }> = {
  ...
  Oct: { bg: "rgba(2,1,74,0.08)",   border: "rgba(2,1,74,0.2)",   text: "#02014a" },
  Nov: { bg: "rgba(200,146,42,0.08)", border: "rgba(200,146,42,0.2)", text: "#a87828" },
  Dec: { bg: "rgba(2,1,74,0.06)",   border: "rgba(2,1,74,0.15)",  text: "#02014a" },
...
function HighlightCard({ icon, label, value, delay, inView }: {
  ...
  return (
    <div style={{
      ...
      <div>
        <div style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(2,1,74,0.4)", marginBottom: "0.2rem", fontFamily: "'DM Sans', system-ui, sans-serif" }}>{label}</div>
        <div style={{ fontSize: "0.9rem", fontWeight: 600, color: "#02014a", lineHeight: 1.4, fontFamily: "'DM Sans', system-ui, sans-serif" }}>{value}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <>
      <style>{`
        ...
        .hl-session-dot:hover { transform: translateY(-3px) scale(1.04); box-shadow: 0 6px 20px rgba(2,1,74,0.12) !important; }
        ...
        .hl-info-table td {
          ...
          font-size: 0.875rem;
          color: #02014a;
          border-bottom: 1px solid rgba(2,1,74,0.06);
          vertical-align: top;
          font-family: 'DM Sans', system-ui, sans-serif;
          line-height: 1.6;
        }
        .hl-info-table tr:last-child td { border-bottom: none; }
        .hl-info-table tr:nth-child(even) td { background: rgba(2,1,74,0.015); }
        ...
        .hl-info-table .zh { display: block; font-size: 0.75rem; color: rgba(2,1,74,0.4); font-weight: 400; margin-top: 2px; }
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "20px",
                  border: "1px solid rgba(2,1,74,0.07)",
                  boxShadow: "0 4px 24px rgba(2,1,74,0.07)",
                  overflow: "hidden",
              ...
              >
                <div style={{ padding: "1.5rem 1.5rem 1rem", borderBottom: "1px solid rgba(2,1,74,0.06)" }}>
                  ...
                  <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(1.3rem, 2vw, 1.65rem)", fontWeight: 700, color: "#02014a", margin: 0, lineHeight: 1.2 }}>
                    SAT Prep Test Program — Fall 2026
                  </h2>
                  <p style={{ fontSize: "0.82rem", color: "rgba(2,1,74,0.45)", margin: "0.4rem 0 0", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td rowSpan={3} style={{ verticalAlign: "middle" }}>
                          ...
                          <div style={{ fontSize: "0.75rem", color: "rgba(2,1,74,0.5)", marginBottom: "0.5rem" }}>3 hours · Every Saturday</div>
                          <div style={{ fontSize: "0.8rem", color: "#02014a", lineHeight: 1.7 }}>
                            9/12, 19, 26<br />
                            10/03, 17, 24, 31<br />
                            11/07, 14, 21<br />
                            12/05, 12, 19<br />
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: "0.85rem", color: "#02014a", margin: 0, lineHeight: 1.6, fontFamily: "'DM Sans', system-ui, sans-serif" }}>
                    Register by <strong>August 20, 2026</strong> to receive a discount off the regular rate.
                  </p>
                  <p style={{ fontSize: "0.8rem", color: "rgba(2,1,74,0.5)", margin: "0.25rem 0 0", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
                    提早在8月20日之前報名可以享有優惠。
                  </p>
                </div>
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", position: "sticky", top: "2rem" }}>
              ...
              <div style={{
                ...
                overflow: "hidden",
                border: "1px solid rgba(2,1,74,0.07)",
                boxShadow: "0 4px 20px rgba(2,1,74,0.08)",
                position: "relative",
              }}>
                ...
                <div style={{
                  ...
                  background: "linear-gradient(to top, rgba(2,1,74,0.85), transparent)",
        ...
        <section style={{ background: "#fff", borderTop: "1px solid rgba(2,1,74,0.06)", padding: "3rem clamp(1.25rem, 5vw, 3rem)" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              <p style={{ fontSize: "0.85rem", color: "rgba(2,1,74,0.5)", margin: "0.3rem 0 0", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
                星期六上課 · 2026年9月12日 開始
              </p>
            </div>

            <div style={{ overflowX: "auto", borderRadius: "14px", border: "1px solid rgba(2,1,74,0.07)", overflow: "hidden" }}>
              <table className="hl-info-table" style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr>
                    <th>項目</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td rowSpan={3}>
                      ...
                      <span style={{ fontSize: "0.8rem", color: "rgba(2,1,74,0.6)" }}>
            ...
            <p style={{ fontSize: "0.85rem", color: "rgba(2,1,74,0.55)", margin: "1rem 0 0", lineHeight: 1.7, fontFamily: "'DM Sans', system-ui, sans-serif" }}>
