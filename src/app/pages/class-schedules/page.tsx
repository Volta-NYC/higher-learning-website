    ...
    <>
      <style>{`
        ...
        .hl-hub-card {
          ...
          box-shadow: 0 2px 16px rgba(2,1,74,0.05);
        ...
        .hl-hub-card:hover {
          box-shadow: 0 10px 32px rgba(2,1,74,0.11);
      ...
      <main className="hl-hub hl-photo-hero hl-photo-hero-schedules">
        <div style={{ width: "100%", maxWidth: "860px" }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{
                      fontSize: "0.82rem", color: "rgba(2,1,74,0.5)",
                    ...
                    <span style={{
                      ...
                      borderRadius: "8px",
                      fontSize: "0.73rem", fontWeight: 600, color: "#02014a",
                      fontFamily: "'DM Sans', system-ui, sans-serif",
                    }}>
                      Time · {s.detail}
                    </span>
          ...
          >
            <p style={{
              fontSize: "0.78rem", color: "rgba(2,1,74,0.35)",
