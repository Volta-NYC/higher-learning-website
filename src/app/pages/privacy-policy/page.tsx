export default function PrivacyPolicyPage() {
  return (
    <div className="bg-white">
      <section className="hl-photo-hero hl-photo-hero-privacy relative isolate overflow-hidden bg-[#02014a] px-5 py-20 text-white sm:px-8 lg:px-12">
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-4xl rounded-[8px] border border-slate-200 bg-white p-7 shadow-[0_18px_55px_rgba(2,1,74,0.08)] md:p-10">
          <div className="space-y-8 text-slate-600">
            <div>
              <h2 className="font-serif text-2xl font-bold tracking-normal text-[#02014a]">Information We Collect</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl font-bold tracking-normal text-[#02014a]">How We Use Information</h2>
              <p className="mt-3 leading-8">
            ...
            <div>
              <h2 className="font-serif text-2xl font-bold tracking-normal text-[#02014a]">Contact</h2>
              <p className="mt-3 leading-8">
