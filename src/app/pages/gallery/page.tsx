  ...
  return (
    <>
      <style>{`
        ...
        .hlg-tile:hover { transform: translateY(-3px); box-shadow: 0 14px 36px rgba(2,1,74,0.18); }
        .hlg-tile-photo {
        ...
        .hlg-tile-overlay {
          ...
          background: linear-gradient(160deg, rgba(2,1,74,0.34) 0%, rgba(2,1,74,0.82) 100%);
        ...
        .hlg-tile:hover .hlg-tile-overlay {
          background: linear-gradient(160deg, rgba(2,1,74,0.45) 0%, rgba(200,146,42,0.35) 100%);
        }
        .hlg-tile-grid {
          position: absolute; inset: 0;
        ...
        <section style={{ padding: "5rem clamp(1.25rem, 5vw, 3rem)" }}>
          ...
          >
            ...
            <div className="hlg-image-frame" style={{
              ...
              boxShadow: "0 12px 40px rgba(2,1,74,0.12)",
            ...
            <div style={{
              ...
              <p style={{
                fontSize: "0.95rem", color: "rgba(2,1,74,0.6)",
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
              ...
              <h2 style={{
                ...
                fontWeight: 700, color: "#02014a", margin: 0,
              }}>
                Learning in Action
              </h2>
            </div>
