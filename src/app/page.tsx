    ...
    <section id={id} className={`py-14 md:py-20 ${className}`}>
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className={`font-serif text-4xl font-bold leading-tight tracking-normal md:text-5xl ${dark ? "text-white" : "text-[#02014a]"}`}>
            {title}
          </h2>
          {subtitle && (
...
function CourseCard({ course, delay }: { course: typeof courses[0]; delay: number }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-serif text-2xl font-bold tracking-normal text-[#02014a]">{course.title}</h3>
...
function PillarCard({ pillar, delay }: { pillar: typeof pillars[0]; delay: number }) {
  ...
  return (
    <article
      ...
      style={{ transitionDelay: `${delay}ms` }}
    >
      <div className="flex h-16 w-16 items-center justify-center rounded-[8px] bg-[#02014a] text-[#e8b84b] shadow-lg shadow-[#02014a]/20">
        <Icon size={30} strokeWidth={1.7} />
      </div>
      <div>
        <h3 className="font-serif text-2xl font-bold tracking-normal text-[#02014a]">{pillar.title}</h3>
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex items-end justify-between gap-4 pt-8">
        <div>
          <div className="font-bold text-[#02014a]">{review.name}</div>
  ...
  return (
    <>
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-8 px-5 sm:px-8 lg:grid-cols-[1fr_26rem] lg:gap-12 lg:px-12">
          <div className="max-w-4xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link href="/pages/contact" className="inline-flex h-13 items-center justify-center rounded-full bg-gradient-to-r from-[#c8922a] to-[#e8b84b] px-7 text-sm font-bold uppercase tracking-[0.14em] text-[#02014a] shadow-[0_14px_35px_rgba(200,146,42,0.32)] transition duration-300 hover:-translate-y-1 hover:text-[#02014a] hover:shadow-[0_18px_45px_rgba(200,146,42,0.48)]">
                <span>
                  Visit Us In Person
          ...
          <aside className="relative hidden overflow-hidden rounded-[8px] border border-white/16 bg-white/8 shadow-[0_30px_90px_rgba(0,0,0,0.25)] backdrop-blur-xl lg:block">
            <div className="relative aspect-[4/5] min-h-[460px] overflow-hidden">
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#02014a]/96 via-[#02014a]/36 to-transparent" />
              <div className="absolute inset-x-5 bottom-5 rounded-[8px] border border-[#e8b84b]/25 bg-[#02014a]/78 p-5 shadow-[0_18px_48px_rgba(0,0,0,0.24)] backdrop-blur">
      ...
      <section ref={statsRef} className="relative z-20 bg-white px-5 sm:px-8 lg:px-12">
        <div className="mx-auto -mt-14 max-w-7xl overflow-hidden rounded-[8px] border border-white/10 bg-[#02014a] shadow-[0_28px_90px_rgba(2,1,74,0.24)]">
      ...
      >
        <div className="hl-campus-carousel-band relative overflow-hidden border-y-2 border-[#c8922a]/70 bg-[#02014a] py-5 shadow-[0_18px_54px_rgba(2,1,74,0.14)]">
          <div className="mb-5 flex items-center justify-center gap-3">
            <button
              type="button"
              onClick={showPreviousGalleryPhoto}
              className="inline-flex h-11 w-11 items-center justify-center border border-[#e8b84b]/70 bg-transparent text-[#e8b84b] transition hover:bg-[#e8b84b] hover:text-[#02014a]"
            ...
            >
              {[...homeGalleryPhotos, ...homeGalleryPhotos].map((photo, index) => (
                ...
                >
                  ...
                  />
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#02014a]/82 to-transparent p-4">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-4 px-5">
            ...
            <Link href="/pages/gallery" className="inline-flex h-10 items-center justify-center border border-[#e8b84b]/70 px-4 text-xs font-bold uppercase tracking-[0.14em] text-[#e8b84b] transition duration-300 hover:bg-[#e8b84b] hover:text-[#02014a]">
              View Full Gallery
              <ChevronRight className="ml-2 h-4 w-4" />
            </Link>
          </div>
      ...
      <Section
        id="why"
        className="bg-[#02014a] bg-[radial-gradient(circle_at_top_right,rgba(232,184,75,0.13),transparent_34%),linear-gradient(135deg,#02014a,#02014a)]"
      ...
      <Section
        id="success"
        className="overflow-hidden bg-[#02014a] bg-[radial-gradient(circle_at_20%_20%,rgba(232,184,75,0.16),transparent_26%),linear-gradient(145deg,#02014a,#02014a)]"
        label="Class of 2026"
      ...
      >
        <div className="hl-admissions-marquee relative overflow-hidden border-y border-white/10 py-6">
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-[#02014a] to-transparent" />
          <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-[#02014a] to-transparent" />
          <div className="marquee-track flex gap-3">
            {[...students, ...students].map((name, i) => (
              <span key={`${name}-${i}`} className="whitespace-nowrap rounded-full border border-[#e8b84b]/20 bg-white/8 px-4 py-2 text-sm font-semibold text-white/75 shadow-sm backdrop-blur transition duration-300 hover:border-[#e8b84b]/60 hover:bg-[#e8b84b] hover:text-[#02014a]">
                {name}
              </span>
            ))}
          </div>
      ...
      >
        ...
        <div className="mt-9 flex justify-center gap-3">
          {Array.from({ length: totalPages }).map((_, i) => (
            <button
              key={i}
              className={`h-2.5 w-2.5 rounded-full transition duration-300 ${i === reviewPage ? "scale-125 bg-[#c8922a]" : "bg-[#02014a]/20 hover:bg-[#02014a]/40"}`}
        ...
        <div className="mt-8 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-[0.14em] text-[#b27a16] transition hover:text-[#02014a]"
          >
      ...
      <section className="relative isolate overflow-hidden bg-[#02014a] px-5 py-14 text-center sm:px-8 md:py-20 lg:px-12">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link href="/pages/contact" className="inline-flex h-13 items-center justify-center rounded-full bg-gradient-to-r from-[#c8922a] to-[#e8b84b] px-7 text-sm font-bold uppercase tracking-[0.14em] text-[#02014a] shadow-[0_14px_35px_rgba(200,146,42,0.32)] transition duration-300 hover:-translate-y-1 hover:text-[#02014a]">
